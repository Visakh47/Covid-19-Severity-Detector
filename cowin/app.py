...
with center_column_1:
    state_inp = formlogin.selectbox('Select State 🚀', [""] + valid_states)
    if state_inp != "":
...
with right_column_1:
    dist_inp = formlogin.selectbox('Select District 🏙️', unique_districts)
